...
public final class PostFurnitureGhostBlockClickEvent extends Event implements Cancellable{
    ...
    public PostFurnitureGhostBlockClickEvent(Player p, Block b, ObjectID o) {

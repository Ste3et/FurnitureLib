...
public final class PostFurnitureClickEvent extends Event implements Cancellable{
    ...
    public PostFurnitureClickEvent(Player p, fEntity a, ObjectID o, Location l) {
    ...
    public fEntity getfEntity(){return this.a;}

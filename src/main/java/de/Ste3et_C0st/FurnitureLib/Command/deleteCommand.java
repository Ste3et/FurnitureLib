		...
		if (args.length == 2) {
			...
			if (project != null) {
				...
				final Component component = MiniMessage.miniMessage().deserialize(
							"<red>Please type <green><u>/furniture delete" + systemID + " confirm" + 
							"<newline><reset><red>to remove it"
					  ).clickEvent(ClickEvent.suggestCommand("/furniture delete " + systemID + " confirm"));

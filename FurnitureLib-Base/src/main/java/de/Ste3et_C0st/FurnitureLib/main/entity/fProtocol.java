...
public class fProtocol {
    ...
    static {
    	packetType = MinecraftVersion.getCurrentVersion().isAtLeast(MinecraftVersion.fromServerVersion("1.18")) ? PacketType.Play.Server.SPAWN_ENTITY : PacketType.Play.Server.SPAWN_ENTITY_LIVING;
    }

...
public class BlockDataConverter26_2 extends BlockDataReader{
	...
	public Optional<BlockData> read(NBTTagCompound compound) {
		...
		CraftItemStack.getReader().ifPresent(itemReader -> {
			try {
				...
				final Constructor<?> constructor = craftBlockDataClass.getDeclaredConstructor(iBlockData.getClass());
				constructor.setAccessible(true);
				Object craftBlockData = constructor.newInstance(iBlockData);

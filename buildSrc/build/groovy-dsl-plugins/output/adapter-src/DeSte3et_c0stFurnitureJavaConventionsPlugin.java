...
/**
 * Precompiled de.Ste3et_C0st.furniture.java-conventions script plugin.
 **/
public class DeSte3et_c0stFurnitureJavaConventionsPlugin implements org.gradle.api.Plugin<org.gradle.api.internal.project.ProjectInternal> {
    ...
    public void apply(org.gradle.api.internal.project.ProjectInternal target) {
        ...
        try {
            Class<? extends BasicScript> pluginsBlockClass = Class.forName("cp_precompiled_DeSte3et_c0stFurnitureJavaConventions").asSubclass(BasicScript.class);

...
public class fText_display extends fDisplay {
	...
	public fText_display setText(final String text) {
		...
		getWatcher().setObject(new WrappedDataWatcherObject(displayField.getVersionIndex() + 22, Registry.getChatComponentSerializer(false)), LanguageManager.getInstance().getWrapped(text));
		return this;
	}

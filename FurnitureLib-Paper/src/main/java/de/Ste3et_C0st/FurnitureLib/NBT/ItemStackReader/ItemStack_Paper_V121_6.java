...
public class ItemStack_Paper_V121_6 extends ItemStackReader{
	...
	public ItemStack getItemStack(NBTTagCompound nbtTagCompound) {
		try {
			...
			final Object CODEC = NmsStack.getField("CODEC").get(null);
			final Object NbtOpsInstance = NbtOps.getField("INSTANCE").get(null);
	...
	public Object convertCompound(NBTTagCompound nbtTagCompound) throws Exception {
		...
		Object heap = NbtAccounter.getMethod("unlimitedHeap").invoke(null);
	...
	public NBTTagCompound getNBTTag(ItemStack is) throws Exception {		
        try {
        	...
        	if(optional.isPresent()) {
        		...
        		NbtIo.getMethod("writeCompressed", optional.get().getClass(), OutputStream.class).invoke(null, optional.get(), os);
